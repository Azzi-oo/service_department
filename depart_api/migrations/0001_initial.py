    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('analyzer', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='depart_api.device', verbose_name='Айди оборудования')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='depart_api.customer', verbose_name='Пользователь')),
            ],
            options={
